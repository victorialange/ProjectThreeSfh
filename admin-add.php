  ...
  <main>
    <section class="addAdventure">
      <div class="wrapper">
        ...
        <h3 class="formHeading">Input details about the trip</h3>
        <!-- form with 4 fields -->
        ...
        <form action="admin-confirm.php" method="post" class="addAdventureForm">
          ...
          <input name="heading" id="heading" type="text" required placeholder="Trip title" maxlength="255" />
          ...
          <textarea name="summary" id="summary" rows="4" required type="text" minlength="10" maxlength="1000" placeholder="Come enjoy the beauty of nature with this trip..."></textarea>
